...
3. `docker build . -t vedph2020/cadmus-tgr-app:1.0.26 -t vedph2020/cadmus-tgr-app:latest` (replace with the current version).
...
3. `docker build . -t vedph2020/cadmus-tgr-app:1.0.27-prod` and then push the image.
