...
3. `docker build . -t vedph2020/cadmus-tgr-app:9.0.3 -t vedph2020/cadmus-tgr-app:latest` (replace with the current version).
...
- 2025-08-08: ⚠️ upgraded to Angular 20.
...
- 2025-02-12: updated Angular and packages.
