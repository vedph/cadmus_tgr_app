...
3. `docker build . -t vedph2020/cadmus-tgr-app:5.0.1 -t vedph2020/cadmus-tgr-app:latest` (replace with the current version).
...
(3) `docker build . -t vedph2020/cadmus-tgr-app:5.0.1-prod` and then push the image.
